...
// MARK: - Multi-Accumulator Helpers

func zip<Accumulator1: GraphQLResultAccumulator, Accumulator2: GraphQLResultAccumulator>(
  _ accumulator1: Accumulator1,
  _ accumulator2: Accumulator2
) -> Zip2Accumulator<Accumulator1, Accumulator2> {
  return Zip2Accumulator(accumulator1, accumulator2)
}

func zip<
  Accumulator1: GraphQLResultAccumulator,
  Accumulator2: GraphQLResultAccumulator,
  Accumulator3: GraphQLResultAccumulator
>(
  _ accumulator1: Accumulator1,
  _ accumulator2: Accumulator2,
  _ accumulator3: Accumulator3
) -> Zip3Accumulator<Accumulator1, Accumulator2, Accumulator3> {
  return Zip3Accumulator(accumulator1, accumulator2, accumulator3)
}

final class Zip2Accumulator<Accumulator1: GraphQLResultAccumulator, Accumulator2: GraphQLResultAccumulator>:
  GraphQLResultAccumulator
{
  ...
  fileprivate init(_ accumulator1: Accumulator1, _ accumulator2: Accumulator2) {
    ...
    self.requiresCacheKeyComputation =
      accumulator1.requiresCacheKeyComputation || accumulator2.requiresCacheKeyComputation
  }

  func accept(scalar: JSONValue, info: FieldExecutionInfo) throws -> PartialResult {
    return (
      try accumulator1.accept(scalar: scalar, info: info),
  ...
  func accept(customScalar: JSONValue, info: FieldExecutionInfo) throws -> PartialResult {
    return (
      try accumulator1.accept(customScalar: customScalar, info: info),
  ...
  func acceptNullValue(info: FieldExecutionInfo) throws -> PartialResult {
    return (
      try accumulator1.acceptNullValue(info: info),
  ...
  func acceptMissingValue(info: FieldExecutionInfo) throws -> PartialResult {
    return (
      try accumulator1.acceptMissingValue(info: info),
  ...
  func accept(childObject: ObjectResult, info: FieldExecutionInfo) throws -> PartialResult {
    return (
      try accumulator1.accept(childObject: childObject.0, info: info),
